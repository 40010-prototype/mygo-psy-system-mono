...
public class ScheduleController {
    ...
    @GetMapping("/schedules/counselor/{counselorId}/weekly")
    ...
    @GetMapping("/schedules/supervisor/{supervisorId}/weekly")
    ...
    @GetMapping("/schedules/pending/supervisor/{supervisorId}/weekly")
